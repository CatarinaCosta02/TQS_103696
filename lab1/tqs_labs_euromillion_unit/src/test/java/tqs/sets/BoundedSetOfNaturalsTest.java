...
class BoundedSetOfNaturalsTest {
    ...
    @Test
    public void testIntersectionForNoIntersection() {
        assertFalse(setA.intersects(setB),"no intersectio");
    }

    @Test
    public void testIntersectsInt(){
        assertTrue(setB.intersects2(50));
        assertFalse(setB.intersects2(100));
    }
